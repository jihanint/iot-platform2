...
const WaterProductionChart = () => {
  ...
  return (
    <Box as="section" className="rgc-water-use-chart" w="full" my={12}>
      <Flex justify="space-between" align="center" w="full" mb="8px">
        <Heading fontSize="md">Produksi Air (m3)</Heading>
        <Box display="flex" width="8%">
          <Select onChange={e => setChartPeriod(e.target.value as IChartPeriod)} w="100%">
