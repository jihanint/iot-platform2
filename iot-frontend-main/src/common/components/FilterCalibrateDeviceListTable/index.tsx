...
interface FilterCalibrateDeviceListTableProps {
...
const FilterCalibrateDeviceListTable = ({
  filterVillageName,
  deviceData,
  onChangeVillageName,
  onApplyFilter,
  onResetFilter,
  onClearSearch,
}: FilterCalibrateDeviceListTableProps) => {
  const btnRef = useRef();
            ...
            <DrawerContent>
              ...
              <DrawerFooter gap={2}>
                ...
                <Button
                  size="sm"
                  onClick={() => {
                    onApplyFilter({ village_name: selectedVillage });
                    onClose();
                  }}
                >
                  Terapkan
...
export default FilterCalibrateDeviceListTable;
